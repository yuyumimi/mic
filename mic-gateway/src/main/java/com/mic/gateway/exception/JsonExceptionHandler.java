package com.mic.gateway.exception;
...
public class JsonExceptionHandler implements ErrorWebExceptionHandler {
    ...
    public Mono<Void> handle(ServerWebExchange serverWebExchange, Throwable throwable) {
        ...
        if (throwable instanceof NotFoundException) {
            ...
            log.error("[gateway全局系统异常]{}",throwable);
        ...
        commonResult=
                CommonResult.builder().message(body).code(String.valueOf(httpStatus.value())).build();
//        String msg = "{\"code\":" + httpStatus.value() + ",\"message\": \"" + body + "\"}";
        result.put("body", commonResult);

        // 错误日志
        ServerHttpRequest request = serverWebExchange.getRequest();
        log.error("[gateway全局系统异常]\r\n请求路径：{}\r\n异常记录：{}", request.getPath(),
